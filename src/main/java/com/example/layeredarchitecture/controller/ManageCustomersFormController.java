...
public class ManageCustomersFormController {
    ...
    private void loadAllCustomers() {
        ...
        /*Get all customers*/
        try {
            ArrayList<CustomerDTO> allCustomers = customerDAOImpl.loadAllCustomer();
    ...
    boolean existCustomer(String id) throws SQLException, ClassNotFoundException {
        boolean s = customerDAOImpl.existCustomers(id);
        return s;
    }
    ...
    private String generateNewId() {
        try {
            ResultSet rst = customerDAOImpl.generateNewId();
            if (rst.next()) {
